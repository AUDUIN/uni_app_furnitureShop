<template>
	<view class="uni-flex uni-column  bgc">
		<view class="flex-item flex-item-V uni-bg-red">
			...
			<view class="book">
				<text class="booklogin" @tap="handleMyCenter('login')">登录</text>
		...
		<view class="flex-item flex-item-V uni-bg-green second-box1">
			<view class=" second-box ">
				<view class="box">
					<input type="confirmtype" class="e-mail" value="" placeholder="请输入用户名" />
				...
				<view class="box2">
					<input type="password" class="pwd" value="" placeholder="请再次输入密码" @blur="checkpwd($event.detail.value)" />
					<image class="human hpwd " src="../../static/login/ion-android-lock%20-%20Ionicons.png" mode="aspectFill"></image>
				</view>

				<view class="box3"><button class="btn-login" type="primary">Next</button></view>
			</view>
